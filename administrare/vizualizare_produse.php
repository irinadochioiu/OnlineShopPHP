...
<body>
	...
	<?php 
		...
		if($result=$mysqli->query("SELECT * FROM produse ORDER BY nume_produs DESC"))
		{
			if($result->num_rows > 0)
			{
				...
				while($row = $result->fetch_object())
				{
					...
					echo '<td><img src="'.$row->imagine_produs.'" width="150" height="150"></td>';
					echo "<td>".$row->categorie_produs."</td>";
					echo "<td>".$row->descriere_produs."</td>";
					echo "<td><a href='modificare_produse.php?id=".$row->id_produs."'>Modificare</a></td>";
					echo "<td><a href='stergere_produse.php?id=".$row->id_produs."'>Stergere</a></td>";
					echo "</tr>";
				}
				echo "</table>";
			}
